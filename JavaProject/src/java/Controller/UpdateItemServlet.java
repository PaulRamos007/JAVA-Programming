...
public class UpdateItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean delivered = Boolean.parseBoolean(request.getParameter("dlv"));
        boolean discontinued = Boolean.parseBoolean(request.getParameter("disc"));
        
        OrderItem forUpdate = new OrderItem(id, status, name, description, quantity, price, delivered, discontinued);
        
        boolean updated = OrderItemAccessor.updateItem(forUpdate);
