...
public class BuildItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("description", toUpdate.getDescription());
        session.setAttribute("quantity", toUpdate.getQuantity());
        session.setAttribute("price", toUpdate.getPrice());
        session.setAttribute("delivered", toUpdate.isDelivered());
        session.setAttribute("discontinued", toUpdate.isDiscontinued());
