...
<html>
    ...
    <body>
        ...
        <table>
            <tr><th>ID</th><th>Status</th><th>Name</th><th>Description</th><th>Quantity</th><th>Price</th><th>Delivered</th><th>Discontinued</th><th></th><th></th></tr>
            ...
            <c:forEach items="${theOrderItems}" var="temp">
                <tr>
                    ...
                    <td>${temp.quantity}</td>
                    <td>${temp.price}</td>
                    <td>${temp.delivered}</td>
                    <td>${temp.discontinued}</td>
